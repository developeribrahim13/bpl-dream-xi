...
const [disable,setDisable] = useState(false)
    return (
        <div className='max-w-[90%] mx-auto font-sora'>
            <div className='flex justify-between items-center mb-6 px-3 flex-wrap'>
                <p className='text-lg md:text-[28px] font-bold'>{available?"Available Players":`Selected Players (${selected.length}/${players.length})`}</p>
                <div className='flex'>
